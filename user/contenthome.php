<?php 
    ...
    ?>
<?php 
// condition might have a problem connecting to database
...
if(isset($_POST["limit"], $_POST["start"])){
            $user_com = $user['company'];
            $user_dep = $user['department'];
            $select_announce = "SELECT * 
            FROM announcement 
            JOIN users ON announcement.announce_user_id = users.id
            WHERE announce_depoption = '$user_dep' AND astatus='1' OR announce_depoption = 'All' OR announce_depoption = '$user_com'
            ...
            <div class="mx-3 my-4 border-0 userhomecard">
                <div class="card-body" style="">
                    <div class="row profile-image px-2">
                        <div class="col-2"><img onerror="this.onerror=null; this.src='/../../icons/users.svg'"
                        ...
                        <div class="col-10">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><button type="button" class="btn w-100 btn-light" style="text-align:start;"
                                            ...
                                            data-bs-target="#modaldelete<?php echo $announce_row['announcement_id']; ?>">Delete</button>
                                                        ...
                                                        <!-- modal popup edit -->
                                                        <div class="modal fade" id="modaledit<?php echo $announce_row['announcement_id']; ?>"
                                    ...
                                    <div class="modal-content">
                                        <form action="/../BaronVerse/update.php" method="POST"
                                            ...
                                            <div class="row profile-image">
                                                <div class="col-2"><img
                                                        onerror="this.onerror=null; this.src='/../../icons/users.svg'"
                                                        src="<?php echo $user['profile_image']; ?>"
                                                        class="rounded-circle" height="40"></div>
                                                <div class="col-10">
                                                    <ul class="cardheadertime">
                                                        <li style="font-weight: 600; font-size: 16px;">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="user_update_announce_btn"
                            ...
                            <!--  -->
                            <!-- Delete -->
                            <div class="modal fade" id="modaldelete<?php echo $announce_row['announcement_id']; ?>"
                                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <form action="/../BaronVerse/delete.php" method="POST">
                                            ...
                                            <input type="hidden" name="announcement_photo"
                                                ...
                                                <input type="hidden" name="announcement_id"
                                                    value="<?php echo $announce_row['announcement_id']; ?>">
                                                <button type="submit" name="user_delete_announcement"
        ...
        <video class="video" style=" max-width: 100%;max-height: 100%;" controls >
            <source src="/../../imgupload/<?php echo $announce_row['announcement_photo']; ?>" type="video/mp4">
        ...
        <div style="text-align:center;">
            <img onerror="this.onerror=null"
                src="/../../imgupload/<?php echo $announce_row['announcement_photo']; ?>"
