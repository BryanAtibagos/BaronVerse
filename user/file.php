            ...
            <div class="modal-content">
                <form action="/../BaronVerse/add.php" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="user_submit_file" class="btn btn-primary">Upload</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/../BaronVerse/add.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="add_link_user" class="btn btn-primary">Add</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
                    ...
                    <table id="" class="table table-sm ">
                        ...
                        <tbody>
                            <tr style="border: 2px solid white;">
                                <td class="col-11">
                                    <div class="link-dashboard"><a href="<?php echo $row_link['link_reference']; ?> "
                            ...
                            <!-- Update -->
                            <div class="modal fade" id="modaledit<?php echo $row_link['link_id']; ?>" tabindex="-1"
                                        ...
                                        <form action="/../BaronVerse/update.php" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="update_link_user"
                            ...
                            <!--  -->
                            <!-- Delete -->
                            <div class="modal fade" id="modaldelete<?php echo $row_link['link_id']; ?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="/../BaronVerse/delete.php" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" name="link_id"
                                                        value="<?php echo $row_link['link_id']; ?>">
                                                    <button type="submit" name="delete_link_user"
                                    ...
                                    <td>
                                        <ul style="display: flex; justify-content: center; padding-left:0px; margin:0;">
                                            <li style="list-style: none; text-align: center;"><a
                                                    class="btn btn-light mx-1" download="<?php echo $row['file_name']?>"
