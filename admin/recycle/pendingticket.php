                        ...
                        <div class="card-body">
                            <div class="users-category">
                                <ul>
                                    ...
                                    <li class="users-li">
                                        <a href="pendingticket.php" class="users-a">Pending Ticket</a>
                                    </li>
                                    <li class="users-li">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <li style="list-style: none; text-align: center;"><button type="button"
                                                        ...
                                                        data-bs-target="#modaledit<?php echo $row['ticket_id']; ?>">Recover</button>
                                                </li>
                                                <li style="list-style: none; text-align: center;"><button type="button"
                                                        class="btn btn-danger mx-1" data-bs-toggle="modal"
                                                        data-bs-target="#modaldelete<?php echo $row['ticket_id']; ?>">Delete</button>
                                                </li>
                                        </ul>
                                    </td>
                                    </tr>
                                        ...
                                        <div class="modal-content">
                                            <form action="/../BaronVerse/update.php" method="POST">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Recover Ticket</h5>
                                                </div>
                                                     ...
                                                     <div class="form-group">
                                                                    ...
                                                                    <div class="form-outline">
                                                                        <textarea class="form-control"  
                                                                            ...
                                                                            id="textAreaExample2"
                                                                            rows="8" disabled><?php echo $row['issue'];?></textarea>
                                                                    </div>
                                                                </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" name="ticket_id"
                                                        ...
                                                        value="1">
                                                    <button type="submit" name="recover_ticket"
                                            ...
                                            <form action="/../BaronVerse/delete.php" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="ticket_id"
                                                            value="<?php echo $row['ticket_id']; ?>">
                                                        <button type="submit" name="per_delete_ticket"
